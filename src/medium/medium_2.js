...
export const allCarStats = {
    ...
    allYearStats: getStatistics(mpg_data.reduce(function(previousValue, currentValue) {
        return [...previousValue, ...currentValue.year]
      }, [])),
    ratioHybrids: mpg_data.reduce(function (acc, obj) {
        let key = obj[hybrid]
        if (!acc[key]) {
          acc[key] = []
        }
